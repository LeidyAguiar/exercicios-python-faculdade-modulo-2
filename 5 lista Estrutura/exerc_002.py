"""
2. Elabore uma estrutura para representar um produto (código, nome, preço). Cadastre 5 produtos, use vetor/lista. 
Aplique 10% de aumento no preço do produto e apresente todos os dados do preço.
"""
...
def main():
    ...
    for i in range(5):
        ...
        p.nome = input('Cadastre o nome do produto: ').ljust(15, ' ')
